...
{
    public class PersonalProfileService : ApplicationServiceBase
    {
        ...
        public void Insert(PersonalProfileDto profile, int userId)
        {
            using (var uow = UnitOfWorkProvider.Create())
            {
                ...
                if (user == null)
                {
                    throw new UIException("Neexistuje užívateľský účet, profil sa nedá uložiť.");
                }
